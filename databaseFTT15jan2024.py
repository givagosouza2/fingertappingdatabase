...
with col2:
    ...
    code_text = ['Code: ' + str(info['Code'][choice])]
    st.write(code_text[0])
    sex_text = ['Sex: ' + str(info['Sex'][choice])]
    st.write(sex_text[0])
    hand_text = ['Hand: ' + str(info['Hand'][choice])]
    st.write(hand_text[0])
    birthyear_text = ['Year of birth: ' + str(info['Year of birth'][choice])]
    st.write(birthyear_text[0])
    testyear_test = ['Year of test: ' + str(info['Year of test'][choice])]
    st.write(testyear_test[0])
    ages = info['Year of test'][choice]-info['Year of birth'][choice]
    ages_text = ['Age during the test: ' + str(ages)]
    st.write(ages_text[0])
    smartphone_text = ['Smartphone: ' + str(info['Smartphone'][choice])]
